...
#define __PYX_HAVE__itdk__graph_utils__paths
#define __PYX_HAVE_API__itdk__graph_utils__paths
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'itdk.graph_utils.paths' */
...
#define __Pyx_MODULE_NAME "itdk.graph_utils.paths"
extern int __pyx_module_is_main_itdk__graph_utils__paths;
int __pyx_module_is_main_itdk__graph_utils__paths = 0;

/* Implementation of 'itdk.graph_utils.paths' */
...
static const char __pyx_k_itdk_graph_utils_paths[] = "itdk.graph_utils.paths";
static const char __pyx_k_itdk_graph_utils_paths_pyx[] = "itdk/graph_utils/paths.pyx";
...
static PyObject *__pyx_n_s_itdk_graph_utils_paths;
...
/* Python wrapper */
static PyObject *__pyx_pw_4itdk_11graph_utils_5paths_1all_paths(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4itdk_11graph_utils_5paths_1all_paths = {"all_paths", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4itdk_11graph_utils_5paths_1all_paths, METH_VARARGS|METH_KEYWORDS, 0};
...
static PyObject *__pyx_pf_4itdk_11graph_utils_5paths_all_paths(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_g, PyObject *__pyx_v_tgs) {
  ...
  std::vector<int>  __pyx_v_targets;
  ...
  double __pyx_t_18;
  std::vector<std::vector<float> > ::size_type __pyx_t_19;
  std::vector<float> ::size_type __pyx_t_20;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("all_paths", 0);
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_g, __pyx_n_s_num_vertices); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_g, __pyx_n_s_edges); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_2);
 ...
 *     for t in tgs:
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_g, __pyx_n_s_ep); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_weight); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_weights = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "itdk/graph_utils/paths.pyx":18
 *     weights = g.ep.weight
 * 
 *     for t in tgs:             # <<<<<<<<<<<<<<
 *         targets.push_back(t)
 ...
 */
  if (unlikely(__pyx_v_tgs == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not iterable");
    __PYX_ERR(0, 18, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_v_tgs; __Pyx_INCREF(__pyx_t_2); __pyx_t_5 = 0;
  for (;;) {
 ...
 */
    __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_t); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
    try {
      __pyx_v_targets.push_back(__pyx_t_4);
    } catch(...) {
      __Pyx_CppExn2PyErr();
 ...
 */
    __pyx_t_11 = ((__pyx_v_row.size() > 0) != 0);
    if (__pyx_t_11) {

      /* "itdk/graph_utils/paths.pyx":24
 *             row.push_back(0.0)
 *         if row.size() > 0:
 *             WU.push_back(row)             # <<<<<<<<<<<<<<
 *             row.erase(row.begin(), row.end())
 ...
 */
  ...
  for (;;) {
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_1))) || (PyList_CheckExact(__pyx_t_1))) {
      ...
      __pyx_t_13 = PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 26, __pyx_L1_error)
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_13))) || (PyList_CheckExact(__pyx_t_13))) {
      ...
      #else
      __pyx_t_14 = PySequence_ITEM(sequence, 0); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_16 = PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      #endif
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    } else {
      Py_ssize_t index = -1;
      __pyx_t_17 = PyObject_GetIter(__pyx_t_13); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_17);
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __pyx_t_15 = Py_TYPE(__pyx_t_17)->tp_iternext;
      index = 0; __pyx_t_14 = __pyx_t_15(__pyx_t_17); if (unlikely(!__pyx_t_14)) goto __pyx_L14_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_14);
      index = 1; __pyx_t_16 = __pyx_t_15(__pyx_t_17); if (unlikely(!__pyx_t_16)) goto __pyx_L14_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_16);
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_15(__pyx_t_17), 2) < 0) __PYX_ERR(0, 26, __pyx_L1_error)
      __pyx_t_15 = NULL;
    ...
    __Pyx_XDECREF_SET(__pyx_v_ep, __pyx_t_14);
    __pyx_t_14 = 0;
    __Pyx_XDECREF_SET(__pyx_v_es, __pyx_t_16);
    __pyx_t_16 = 0;

    /* "itdk/graph_utils/paths.pyx":27
 *             row.erase(row.begin(), row.end())
 *     for w, (ep, es) in zip(weights, edges):
 *         p = int(ep)             # <<<<<<<<<<<<<<
 *         s = int(es)
 *         if p > s:
 */
    __pyx_t_1 = __Pyx_PyNumber_Int(__pyx_v_ep); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_XDECREF_SET(__pyx_v_p, __pyx_t_1);
    __pyx_t_1 = 0;

    /* "itdk/graph_utils/paths.pyx":28
 *     for w, (ep, es) in zip(weights, edges):
 *         p = int(ep)
 *         s = int(es)             # <<<<<<<<<<<<<<
 *         if p > s:
 *             WU[s][p - s] = float(w)
 */
    __pyx_t_1 = __Pyx_PyNumber_Int(__pyx_v_es); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_XDECREF_SET(__pyx_v_s, __pyx_t_1);
    __pyx_t_1 = 0;

    /* "itdk/graph_utils/paths.pyx":29
 *         p = int(ep)
 *         s = int(es)
 *         if p > s:             # <<<<<<<<<<<<<<
 *             WU[s][p - s] = float(w)
 *         else:
 */
    __pyx_t_1 = PyObject_RichCompare(__pyx_v_p, __pyx_v_s, Py_GT); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
    __pyx_t_11 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_11 < 0)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (__pyx_t_11) {

      /* "itdk/graph_utils/paths.pyx":30
 *         s = int(es)
 *         if p > s:
 *             WU[s][p - s] = float(w)             # <<<<<<<<<<<<<<
 *         else:
 *             WU[p][s - p] = float(w)
 */
      __pyx_t_18 = __Pyx_PyObject_AsDouble(__pyx_v_w); if (unlikely(__pyx_t_18 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
      __pyx_t_19 = __Pyx_PyInt_As_size_t(__pyx_v_s); if (unlikely((__pyx_t_19 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
      __pyx_t_1 = PyNumber_Subtract(__pyx_v_p, __pyx_v_s); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_20 = __Pyx_PyInt_As_size_t(__pyx_t_1); if (unlikely((__pyx_t_20 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      ((__pyx_v_WU[__pyx_t_19])[__pyx_t_20]) = __pyx_t_18;
 ...
 */
    /*else*/ {
      ...
      __pyx_t_19 = __Pyx_PyInt_As_size_t(__pyx_v_p); if (unlikely((__pyx_t_19 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L1_error)
      __pyx_t_1 = PyNumber_Subtract(__pyx_v_s, __pyx_v_p); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_20 = __Pyx_PyInt_As_size_t(__pyx_t_1); if (unlikely((__pyx_t_20 == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      ((__pyx_v_WU[__pyx_t_19])[__pyx_t_20]) = __pyx_t_18;
    }
    __pyx_L16:;
...
static int __pyx_pymod_exec_paths(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_paths},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_itdk_graph_utils_paths, __pyx_k_itdk_graph_utils_paths, sizeof(__pyx_k_itdk_graph_utils_paths), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpaths(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpaths(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_paths(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_paths(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_paths(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'paths' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_paths(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("paths", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_itdk__graph_utils__paths) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "itdk.graph_utils.paths")) {
      if (unlikely(PyDict_SetItemString(modules, "itdk.graph_utils.paths", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef vector[vector[float]] WU
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4itdk_11graph_utils_5paths_1all_paths, NULL, __pyx_n_s_itdk_graph_utils_paths); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all_paths, __pyx_t_1) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "itdk/graph_utils/paths.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init itdk.graph_utils.paths", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init itdk.graph_utils.paths");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
